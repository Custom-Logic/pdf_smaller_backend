...
class JobStatusManager:
    ...
    @staticmethod
    def get_or_create_job(job_id: str, task_type: str, input_data: Dict[str, Any]) -> Optional[Job]:
        ...
        if not job:
            ...
            job = JobOperations.create_job(job_id, task_type, input_data)
            if job:
    ...
    def update_job_status(job_id: str, status: JobStatus,
        ...
        def status_update_operation(job: Job, session) -> bool:
        ...
        return JobOperations.execute_with_lock(job_id, status_update_operation)
    ...
    def retry_failed_job(job_id: str) -> bool:
        ...
        return JobOperations.execute_with_lock(job_id, retry_operation)
    ...
    def cancel_job(job_id: str) -> bool:
        ...
        return JobOperations.execute_with_lock(job_id, cancel_operation)